  ...
  function updateSchoolList() {
      setTimeout(() => {
          ...
          schoolData.forEach((school, index) => {
              let schoolItem = $(`
                  <div class="flex justify-between items-center bg-white shadow-md p-3 sm:p-4 rounded-lg transform transition-all duration-500 opacity-0 translate-y-10 border-2 border-transparent hover:border-pink-500 cursor-default">
