$(document).ready(function () {
    ...
    function updateSchoolList() {
      ...
      schoolData.forEach((school) => {
        let schoolItem = $(`
                  <div class="flex justify-between items-center bg-white shadow-md p-3 sm:p-4 rounded-lg transform transition duration-300 hover:scale-105 border-2 border-transparent hover:border-pink-500 cursor-default">
